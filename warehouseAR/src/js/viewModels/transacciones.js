 ...
 */
define(['jquery', 'appController','ojs/ojcore', 'knockout', 'data/data', 'ojs/ojrouter', 'ojs/ojknockout', 'promise', 'ojs/ojlistview'],
 function($, app, oj, ko,  data) {
    ...
    function TransaccionesViewModel() {
      ...
      self.getPhoto = function (id) {
                    var src = '';
                    src = 'css/images/usuarios/' + id + '.png';
                    return src;
                };
